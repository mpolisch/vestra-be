...
CRITICAL INSTRUCTION: The plan data and projection results below are fetched live from the database at the moment of each message. They ALWAYS reflect the user's most current plan, regardless of what was discussed previously. If the user says "I made changes" or "I updated my plan", the data below already includes those changes. Do NOT ask the user to confirm what they changed — the current values ARE the updated values. Simply respond based on what you see below. Never say "I don't see your changes" — if the user says they made changes, trust that the data below reflects them.
